...
urlpatterns = [
    ...
    # path('normal_categories',views.normal_categories,name='normalcategories'),
    path('normal_categories/',views.NormalCategoriesView.as_view(),name='normalcategories'),

    #------- Cat View Functions ------------
    # path('cat_categories',views.cat_categories,name='catcategories'),
    path('gaming_categories/',views.GamingCategoriesView.as_view(),name='gamingcategories'),


    
    # path('Laptop_details',views.Laptop_details,name='Laptopdetails'),
    path('laptop_details/<int:id>/',views.LaptopDetailView.as_view(),name='laptopdetails'),
